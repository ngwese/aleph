...
//-------------------------------------------------
//---- static vars
static const char* op_frames_instring = "INDEX\0  STEP\0   KEY\0    CLEAR\0  A\0      B\0      C\0      D\0      MUTEA\0  MUTEB\0  MUTEC\0  MUTED\0";
static const char* op_frames_outstring = "A\0      B\0      C\0      D\0      ";
static const char* op_frames_opstring = "FRAMES";

static op_in_fn op_frames_in_fn[12] = {
...
void op_frames_init(void* mem) {
  ...
  frames->in_val[3] = &(frames->clear);
  frames->in_val[4] = &(frames->in[0]);
  frames->in_val[5] = &(frames->in[1]);
  frames->in_val[6] = &(frames->in[2]);
  frames->in_val[7] = &(frames->in[3]);
  frames->in_val[8] = &(frames->mute[0]);
  frames->in_val[9] = &(frames->mute[1]);
  frames->in_val[10] = &(frames->mute[2]);
  frames->in_val[11] = &(frames->mute[3]);
